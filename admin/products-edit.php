                                        ...
                                        <h6 for="primary-colors" class="title-card">SPECIFICATIONS</h6>    
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select name="stone_cat" id="stone_cat" class="form-select">
                                                    <?php 
                                                    for($k=0;$k<count($stoneCat);$k++){
                                                        $selected = $k==$selectProdRes['prod_stone_cat'] ? 'selected' : '';
                                                     echo "<option value='$k' $selected >".$stoneCat[$k]."</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                            ...
                                            <?php 
                                                $finishArr=json_decode($selectProdRes['prod_finishes']);
                                            ?>
                                            <div class="col-md-12">
                                                <label for="finishes">AVAILABLE FINISHES</label>
                                                    <div class="form-check">
                                                        <input class="form-check-input prod_finish" name="prod_finish" type="checkbox" value="0" id="polished" <?=in_array(0,$finishArr) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="polished">
                                                            Polished
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input prod_finish" name="prod_finish" type="checkbox" value="1" id="honed" <?=in_array(1,$finishArr) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="honed" >
                                                        Honed
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input prod_finish" name="prod_finish" type="checkbox" value="2" id="matte" <?=in_array(2,$finishArr) ? 'checked' : '' ?>>
                                                        <label class="form-check-label" for="matte">
                                                        Matte
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input prod_finish" name="prod_finish" type="checkbox" value="3" id="leather" <?=in_array(3,$finishArr) ? 'checked' : '' ?>>
  ...
  function deleteImage(id){
    ...
    $('.preview-div-'+id).remove();
            ...
            const detailSubmit = ()=>{
                ...
                console.log(prodSku);
                console.log(prodSeries);
                console.log(prodFinish);

               if(prodName=='' || primColor=='' || stoneCat=='' || prodOrigin=='' || prodSku=='' || prodSeries=='' || prodFinish.length=='' || slabSize1=='' || slabId1=='' || slabSize2=='' || priceRange=='' ) {
                    ...
                    let postData={prodName, primColor , stoneCat , prodOrigin , prodSeries, prodFinishs, prodSku, priceRange,slabSize1, slabId1, slabSize2, flooringResidential , flooringCommercial , counterResidential , counterCommercial , wallResidential , wallCommercial , exterior ,prodId:<?=$prodId?> };
