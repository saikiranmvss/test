    ...
    $('.preview-div-'+id).remove();
            ...
            const detailSubmit = ()=>{
               ...
               if(prodName=='' || primColor=='' || stoneCat=='' || prodOrigin=='' || prodSku=='' || prodSeries=='' || prodFinish=='' || slabSize1=='' || slabId1=='' || slabSize2=='' || priceRange=='' ) {
                    ...
                    let postData={prodName, primColor , stoneCat , prodOrigin , prodSeries, prodFinish, prodSku, priceRange,slabSize1, slabId1, slabSize2, flooringResidential , flooringCommercial , counterResidential , counterCommercial , wallResidential , wallCommercial , exterior ,prodId:<?=$prodId?> };
