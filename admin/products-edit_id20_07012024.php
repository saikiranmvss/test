                        ...
                        <div class="row">
                            <div class="col-12" style="position:absolute">
                                <div class="card" id="images-card">
                                    ...
                                    <?php
                                     $images= json_decode($selectProdRes['prod_images']);
                                     for($i=0;$i<count($images);$i++){
                                        ?>
                                    <div class="col-md-1 preview-div-<?=$i?>"><a href="javascript:void(0)" class="image-show"><i class="bi bi-x custom-icon" onclick="deleteImage(<?=$i?>)"></i><img src="../images/<?=$images[$i]?>" alt=""></a></div>
                                    <?php
                                         } 
                                      ?>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <h6 for="primary-colors" class="title-card">SPECIFICATIONS</h6>    
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="accent-color" placeholder="ACCENT COLOR(S)" value="<?=$selectProdRes['prod_accent_color']?>">
                                            </div>
                                            <div class="col-md-12 d-none">
                                                <label for="other-industry">OTHER INDUSTRY</label>
                                                <input type="text" class="form-control" id="other-industry" placeholder="OTHER INDUSTRY" value="<?=$selectProdRes['other_industry']?>">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="spec-style">SERIES</label>
                                                <input type="text" class="form-control" id="spec-style" placeholder="SERIES" value="<?=$selectProdRes['prod_spec_style']?>">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="finishes">AVAILABLE FINISHES</label>
                                                <input type="text" class="form-control" id="finishes" placeholder="AVAILABLE FINISHES" value="<?=$selectProdRes['prod_finishes']?>">
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <h6 for="primary-colors" class="title-card">SIZES</h6>
                                            <div class="col-md-12">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control mt-2" id="slab-id1" placeholder="ID#" value="<?=$selectProdRes['prod_slab_id1']?>">
                                                </div>
                                                <div class="col-md-12 mt-4 d-none">
                                                    ...
                                                    <input type="text" class="form-control mt-2" id="slab-id2" placeholder="ID#" value="<?=$selectProdRes['prod_slab_id2']?>">
                                                </div>
                                                <div class="col-md-12 mt-2 d-none">
                                                    <label for="primary-colors">PREFABS</label>
                                                    <input type="text" class="form-control mt-2" id="prefab-size1" placeholder="Size" value="<?=$selectProdRes['prod_prefab_size1']?>">
                                                    <input type="text" class="form-control mt-2" id="prefab-id1" placeholder="ID#" value="<?=$selectProdRes['prod_prefab_id1']?>">
                                                </div>
                                                <div class="col-md-12 mt-4 d-none">
                                                    <input type="text" class="form-control mt-2" id="prefab-size2" placeholder="Size" value="<?=$selectProdRes['prod_prefab_size2']?>">
                                                    <input type="text" class="form-control mt-2" id="prefab-id2" placeholder="ID#" value="<?=$selectProdRes['prod_prefab_id2']?>">
                                                </div>
                                            </div>
                                        </div>
...
var filesArray=[];
filesArray=JSON.parse('<?php echo $selectProdRes['prod_images']; ?>');
    ...
    $('.preview-div-'+id).remove();
            ...
            const detailSubmit = ()=>{
                ...
                if(prodName=='' || primColor=='' || accentColor=='' || otherIndustry=='' || specStyle=='' || finishes=='' || priceRange=='' || slabSize1=='' || slabId1=='' || slabSize2=='' || slabId2=='' || prefabSize1=='' || prefabId1=='' || prefabSize2=='' || prefabId2=='' ) {
                    ...
                    let postData={prodName, primColor , accentColor , otherIndustry , specStyle,  finishes, priceRange,slabSize1, slabId1, slabSize2, slabId2, prefabSize1 , prefabId1, prefabSize2, prefabId2, flooringResidential , flooringCommercial , counterResidential , counterCommercial , wallResidential , wallCommercial , exterior ,prodId:<?=$prodId?> };
