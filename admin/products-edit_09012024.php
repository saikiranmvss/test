                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <h6 for="primary-colors" class="title-card">SPECIFICATIONS</h6>    
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="select2 form-control select2-multiple" id="prod_finish" name="prod_finish" multiple="multiple" multiple data-placeholder="Choose ...">
                                                    <?php 
                                                    $finishArr=json_decode($selectProdRes['prod_finishes']);
                                                    for($j=0;$j<count($finishes);$j++){
                                                        if(in_array($j,$finishArr)){
                                                            $selected='selected';    
                                                        }else{
                                                            $selected='';    
                                                        }
                                                        // $selected = $j==$selectProdRes['prod_finishes'] ? 'selected' : '';
                                                    echo "<option value='$j' $selected >".$finishes[$j]."</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
