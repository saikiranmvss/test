                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <h6 for="primary-colors" class="title-card">SPECIFICATIONS</h6>    
                                            ...
                                            <div class="col-md-12 d-none">
                                                ...
                                                <input type="text" class="form-control" id="other-industry" placeholder="OTHER INDUSTRY" value="sample">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="spec-style">SERIES</label>
                                                <input type="text" class="form-control" id="spec-style" placeholder="SERIES">
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <h6 for="primary-colors" class="title-card">SIZES</h6>
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12 mt-4 d-none">
                                                    <input type="text" class="form-control mt-2" id="slab-size2" placeholder="Size" value="7CM">
                                                    <input type="text" class="form-control mt-2" id="slab-id2" placeholder="ID#" value="DFD">
                                                </div>
                                                <div class="col-md-12 mt-2 d-none">
                                                    <label for="primary-colors">PREFABS</label>
                                                    <input type="text" class="form-control mt-2" id="prefab-size1" placeholder="Size" value="7CM">
                                                    <input type="text" class="form-control mt-2" id="prefab-id1" placeholder="ID#" value="DFD">
                                                </div>
                                                <div class="col-md-12 mt-4 d-none">
                                                    <input type="text" class="form-control mt-2" id="prefab-size2" placeholder="Size" value="7CM">
                                                    <input type="text" class="form-control mt-2" id="prefab-id2" placeholder="ID#" value="DFD">
                                                </div>
                                            </div>
                                        </div>
