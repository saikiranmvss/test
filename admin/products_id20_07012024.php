...
$selectProds=$dbConn->execute("SELECT prod_id,prod_name,prod_images From products_data WHERE prod_images IS NOT NULL AND prod_status!=1 ORDER BY created_date DESC");
...
<!--                            <a class="link">Join Franchise</a>-->
        ...
        <div class="filterbar">
            ...
            <div class="buttn">
                ...
                <div class="options">
                    <label>
                        <input type="checkbox"> Granite
                    </label>
                    <label>
                        <input type="checkbox"> Marble
                    </label>
                    <label>
                        <input type="checkbox"> Onyx
                    </label>
                    <label>
                        <input type="checkbox"> Porcelain
                    </label>
                    <label>
                        <input type="checkbox"> Quartz
                    </label>
                    <label>
                        <input type="checkbox"> Quartzite
                    </label>
                    <label>
                        <input type="checkbox"> Semi Precious
                    </label>
                </div>
            </div>
            <div class="buttn">
                ...
                <div class="options">
                    <label>
                        <input type="checkbox"> 2CM
                    </label>
                    <label>
                        <input type="checkbox"> 3 CM
                    </label>
                </div>
            </div>
            <div class="buttn">
                ...
                <div class="options">
                    <label>
                        <input type="checkbox"> Polished
                    </label>
                    <label>
                        <input type="checkbox"> Honed
                    </label>
                    <label>
                        <input type="checkbox"> Matte
                    </label>
                    <label>
            ...
            <div class="buttn">
                Application <i class="fas fa-chevron-down"></i>
        ...
        <div class="prod-gallery">
           <div class="col-12 p-0"><button class="productreset">Reset <i class="far fa-arrow-alt-circle-right"></i></button></div>
           <?php while($selectProdsRow=mysqli_fetch_array($selectProds)){  ?>

            <!--<a href="products-edit.php?prod_id=<?=$selectProdsRow['prod_id']?>" class="wrap">-->
            <!--<div class="product-edit-pen"><i class="bi bi-pen"></i></div>-->
            ...
            <div class="product-edit-pen"><i class="bi bi-pen" onclick="window.location.href='products-edit.php?prod_id=<?=$selectProdsRow['prod_id']?>'"></i><i class="bi bi-trash delete-prod" onclick="delete_prod(<?=$selectProdsRow['prod_id']?>)"></i></div>
                <img src="<?= '../images/'.json_decode($selectProdsRow['prod_images'])[0]?>">
                <h5><?=$selectProdsRow['prod_name']?></h5>
            </a>
